...
const AppUpdater = (function() {
    ...
    function showMirrorSelector(info) {
        ...
        if (selector) {
            ...
            const mirrorNames = ['gh-proxy.com（推荐）', 'ghproxy镜像', 'gh-proxy.net', 'GitHub直连'];
            let html = '';
